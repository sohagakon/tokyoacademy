...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tokyo Academy | Study in Japan" },
      {
        name: "description",
        content: "Japanese language, study in Japan and career support for Bangladeshi students.",
      },
      { name: "author", content: "Tokyo Academy" },
